...
func targetFromStuct(arg crud.Event) *kong.Target {
	target, ok := arg.Obj.(*kong.Target)
	if !ok {
		panic("unexpected type, expected *kong.Target")
	}
...
// It returns a the created *kong.Target.
...
// else the function will panic.
// It returns a the updated *kong.Target.
